...
<html lang="pt-BR">
    <head>
        ...
        <title>The Alchemy of Apollo | A Prima Materia</title>
        ...
        .box {
            padding: 20px;
            background-image: url("./Mídias/sakaiii.png") !important;
        ...
        body.light-mode .box {
            background-image: url("./Mídias/sakai.png") !important;
  ...
  <body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active disabled">A <i>Prima Materia</i></a>
              </li>
    ...
    <div class="content d-flex align-items-center justify-content-center" style="min-height: 80vh;">
        <div class="col-11 col-md-10 text-center text-md-start box">
            <h2 class="title" style="font-size: 40px;">O Início de Tudo</h2>
            <p class="justificado">&nbsp;&nbsp;&nbsp;Uma das grandes teorias do nascimento do nosso sol indica que, antes de sequer existir sol (ou seja, há muitos e muitos anos), a maior parte do universo era banhada por temperaturas absurdamente baixas. No lugar posteriormente ocupado pelo sol, existia uma grande nuvem de gás molecular que aumentava de tamanho e densidade de tempos em tempos.</p>
            <p class="justificado">&nbsp;&nbsp;&nbsp;Talvez devido ao colapso gravitacional deste do gás interestelar anteriormente dito (resultado da "grande acumulação" por gravidade), talvez devido a uma contribuição de energia extra vinda da explosão de uma estrela ou supernova vizinha, houve o nascimento de uma proto-estrela.</p>
            <p class="justificado">&nbsp;&nbsp;&nbsp;<i>Essa proto-estrela nada mais era do que o nosso sol bebé!</i></p>
            <div class="text-center">
                <img src="https://tm.ibxk.com.br/2020/11/04/04174310312253.jpg?ims=1200x675" class="img-fluid" style="width: 700px;" alt="Proto-estrela em Formação" title="Proto-estrela em Formação">
            </div>
            <p class="justificado">&nbsp;&nbsp;&nbsp;Durante seu crescimento inicial, a proto-estrela continuou a atrair gás e matéria, formando um disco de material em seu redor (que seriam mais tarde onde os planetas se formariam), e ao alcançar densidade e pressão suficientes, conseguiu transformar hidrogénio em hélio e dando origem ao vento interestelar, que limpou os escombros das órbitas dos actuais planetas.</p>
            <p class="justificado">&nbsp;&nbsp;&nbsp;A par do crescimento do sol, toda a matéria que não era incorporada nele acabou por criar planetas, luas, asteróides e o resto do que chamamos hoje de sistema solar. No interior do disco anteriormente dito, ficaram os materiais mais pesados, unidos devido à gravidade, e deram origem aos planetas rochosos. Após a formação do Sol, o vento solar também arrastou os materiais mais leves para o exterior do Sistema Solar, onde ocorreu a formação dos gigantes gasosos e planetas anões (como chamamos Plutão).</p>
            <div class="text-center">
                <img src="https://geobservatorio.com/wp-content/uploads/2020/05/Solar-System-Birth-2.jpg" class="img-fluid" style="width: 700px;" alt="Formação do Sistema Solar com o Vento interestelar" title="Formação do Sistema Solar com o Vento interestelar">
            </div>
            <p class="justificado">&nbsp;&nbsp;&nbsp;E assim, aproximadamente 4570 milhões de anos depois, temos o nosso sol a oferecer-nos dias claros e verões calorosos!</p>
        </div>
    </div>
