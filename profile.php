...
// verifica se é perfil do próprio user ou de outro
if (isset($_GET['id'])) {
    $user_id = (int) $_GET['id']; // vendo outro perfil
} else {
    if (!$isLoggedIn) {
        header("Location: login.php");
        exit;
    }
    $user_id = $viewer_id; // é o próprio perfil
}
...
// Busca dados do utilizador exibido
...
<title><?php echo htmlspecialchars($username); ?> | O Meu Perfil</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item"><a class="nav-link" href="community.php">Comunidade</a></li>
      </ul>
...
<div class="container profile-container">
    <img src="<?php echo htmlspecialchars($profile_pic_path); ?>" alt="Foto de Perfil" class="profile-pic">
    ...
    <div style="margin-top: 15px; font-size: 1.2rem;">
        ...
        style="margin-right: 20px;">
            Seguidores: <?php echo $followers_count; ?>
        </a>
        |&nbsp;&nbsp;&nbsp;
        <a href="#" data-bs-toggle="modal" data-bs-target="#followingModal">
            A Seguir: <?php echo $following_count; ?>
        </a>
    </div>
    <?php if ($viewer_id === $user_id): ?>
      <!-- DONO DO PERFIL -->
      <a href="edit-profile.php" class="btn btn-warning btn-edit">Editar Perfil</a>

  <?php else: ?>

      <!-- VER PERFIL DE OUTRA PESSOA -->
      <a href="follow_action.php?id=<?php echo $user_id; ?>"
        class="btn btn-<?php echo $isFollowing ? 'danger' : 'success'; ?> btn-edit">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title"><?php echo $followers_count; ?> seguidores</h5>
      ...
      <div class="modal-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="user.php?id=<?php echo $f['id']; ?>" class="ms-3 username-modal">
...
<div class="modal fade" id="followingModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title"><?php echo $following_count; ?> a seguir</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
    ...
    <footer style="margin: 0;">
      <div class="footer-content">
        ...
        <ul>
          ...
          <li><a href="user.php"><i class="fas fa-info-circle"></i> Surpreenda-me</a></li>
