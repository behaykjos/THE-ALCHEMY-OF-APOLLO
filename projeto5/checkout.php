...
<html lang="en">
<head>
<title>Finalizar Compra | Cinnamoroll Shopping</title>
        ...
        <div class="checkout">
            <div class="row">
                ...
                <div class="col-md-4 order-md-2 mb-4">
                    ...
                    <a href="index.php" class="btn btn-sm btn-info">+ adicionar items</a>
                </div>
                <div class="col-md-8 order-md-1">
                    ...
                    <form method="post" action="cartAction.php">
                        ...
                        <input class="btn btn-success btn-block" type="submit" name="checkoutSubmit" value="Confirmar Pedido">
                    </form>
                </div>
            </div>
        </div>
